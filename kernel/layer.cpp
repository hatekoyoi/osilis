...
void
Layer::DrawTo(PixelWriter& writer) const {
    if (window_) {
...
void
LayerManager::SetWriter(PixelWriter* writer) {
    writer_ = writer;
}
...
void
LayerManager::Move(unsigned int id, Vector2D<int> new_position) {
